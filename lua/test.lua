...
lfs.mkdir(result_path .. result_dir);

while (vehicles_num <= 100) do

  local results_dir = "vehicles_num_v0/"
  ...
  while (init_velocity <= 120) do
    ...
    local cmd_line = " --vehicles=" .. vehicles_num .. " --init_velocity=" .. init_velocity
