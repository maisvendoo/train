...
local results_dir = "empty_vehicles_num_v0/"

lfs.mkdir(result_path .. results_dir);

while (vehicles_num <= 100) 
do
  ...
  while (init_velocity <= 120) 
  do
    
    local cmd_line = " --vehicles=" .. vehicles_num .. " --init_velocity=" .. init_velocity .. " --payload_coeff=0.0"
